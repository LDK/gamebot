...
(function(){
    ...
    googleChartApiPromiseFactory.$inject = ['$rootScope', '$q', 'googleChartApiConfig', 'googlechart'];
        
    function googleChartApiPromiseFactory($rootScope, $q, apiConfig, googlechart) {
...
(function(){
    angular.module('googlechart')
        .provider('googlechart', googlechartUrlProvider);
        
    function googlechartUrlProvider() {
        var protocol = 'https:';
